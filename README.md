# nvim-treesitter-queries-desktop

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-desktop/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-desktop/actions/workflows/validate.yml)

Neovim tree-sitter queries for **desktop**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-desktop",
...
- [ ] Changes are scoped to `desktop` — do not include files for other languages
